...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ id: string; created_at: string; organization_id: string; role: 'owner' | 'admin' | 'billing' | 'member'; updated_at: string; user_id: string; }",
    markdown:
      "## get\n\n`client.organizations.memberships.get(organization_id: string, membership_id: string): { id: string; created_at: string; organization_id: string; role: 'owner' | 'admin' | 'billing' | 'member'; updated_at: string; user_id: string; }`\n\n**get** `/v1/organizations/{organization_id}/memberships/{membership_id}`\n\nGet details about an organization membership\n\n### Parameters\n\n- `organization_id: string`\n\n- `membership_id: string`\n\n### Returns\n\n- `{ id: string; created_at: string; organization_id: string; role: 'owner' | 'admin' | 'billing' | 'member'; updated_at: string; user_id: string; }`\n  Organization membership details.\n\n  - `id: string`\n  - `created_at: string`\n  - `organization_id: string`\n  - `role: 'owner' | 'admin' | 'billing' | 'member'`\n  - `updated_at: string`\n  - `user_id: string`\n\n### Example\n\n```typescript\nimport NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs();\n\nconst organizationMembership = await client.organizations.memberships.get('membership_id', { organization_id: 'organization_id' });\n\nconsole.log(organizationMembership);\n```",
    perLanguage: {
      typescript: {
  ...
  {
    name: 'cost',
    endpoint: '/v1/organizations/{organization_id}/billing/cost',
    httpMethod: 'get',
    ...
    stainlessPath: '(resource) organizations.billing > (method) cost',
    qualified: 'client.organizations.billing.cost',
    params: ['organization_id: string;', 'from?: string;', 'to?: string;'],
    response: '{ currency: string; days: { cost: string; date: string; }[]; from: string; to: string; }',
    markdown:
      "## cost\n\n`client.organizations.billing.cost(organization_id: string, from?: string, to?: string): { currency: string; days: daily_cost_point[]; from: string; to: string; }`\n\n**get** `/v1/organizations/{organization_id}/billing/cost`\n\nGet the organization's total usage cost per UTC day over a date range (max 90 days), summing open and closed resources. One entry per day, oldest first. Defaults to the last 30 days.\n\n### Parameters\n\n- `organization_id: string`\n\n- `from?: string`\n  Inclusive start day, YYYY-MM-DD (UTC). Defaults to 30 days before to.\n\n- `to?: string`\n  Inclusive end day, YYYY-MM-DD (UTC). Defaults to today.\n\n### Returns\n\n- `{ currency: string; days: { cost: string; date: string; }[]; from: string; to: string; }`\n  Daily usage cost over a date range: one entry per UTC day (zero on idle days), summing open and closed resources. Suitable for a daily cost bar chart.\n\n  - `currency: string`\n  - `days: { cost: string; date: string; }[]`\n  - `from: string`\n  - `to: string`\n\n### Example\n\n```typescript\nimport NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs();\n\nconst organizationDailyCost = await client.organizations.billing.cost('organization_id');\n\nconsole.log(organizationDailyCost);\n```",
    perLanguage: {
      typescript: {
        method: 'client.organizations.billing.cost',
        example:
          "import NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs({\n  apiKey: process.env['NIRVANA_LABS_API_KEY'], // This is the default and can be omitted\n});\n\nconst organizationDailyCost = await client.organizations.billing.cost('organization_id');\n\nconsole.log(organizationDailyCost.currency);",
      },
      http: {
        example:
  ...
  {
    name: 'history',
    endpoint: '/v1/organizations/{organization_id}/billing/history',
    httpMethod: 'get',
    ...
    perLanguage: {
      typescript: {
        ...
        example:
          "import NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs({\n  apiKey: process.env['NIRVANA_LABS_API_KEY'], // This is the default and can be omitted\n});\n\nconst billingHistoryEntryList = await client.organizations.billing.history('organization_id');\n\nconsole.log(billingHistoryEntryList.items);",
      },
      http: {
        example:
  ...
  {
    name: 'top_up',
    endpoint: '/v1/organizations/{organization_id}/billing/topup',
    httpMethod: 'post',
    ...
    stainlessPath: '(resource) organizations.billing > (method) top_up',
    qualified: 'client.organizations.billing.topUp',
    params: ['organization_id: string;', 'amount: string;', 'Idempotency-Key: string;'],
    response:
      '{ daily_cost: string; effective_balance: string; monthly_cost: string; recharge_threshold_days: string; estimated_next_charge_at?: string; runway_months?: string; }',
    markdown:
      "## top_up\n\n`client.organizations.billing.topUp(organization_id: string, amount: string, Idempotency-Key: string): { daily_cost: string; effective_balance: string; monthly_cost: string; recharge_threshold_days: string; estimated_next_charge_at?: string; runway_months?: string; }`\n\n**post** `/v1/organizations/{organization_id}/billing/topup`\n\nCharge the card on file and credit the prepaid balance. A unique Idempotency-Key header is required; reuse it across retries so a timed-out top-up is not charged twice.\n\n### Parameters\n\n- `organization_id: string`\n\n- `amount: string`\n  Amount to charge and credit, in USD. Must be greater than 0, at most two decimal places, and at most 10000.\n\n- `Idempotency-Key: string`\n\n### Returns\n\n- `{ daily_cost: string; effective_balance: string; monthly_cost: string; recharge_threshold_days: string; estimated_next_charge_at?: string; runway_months?: string; }`\n  Forward-looking billing summary for an organization. All costs are run-rate projections from the organization's current active usage (\"≈ $X/mo at current usage\").\n\n  - `daily_cost: string`\n  - `effective_balance: string`\n  - `monthly_cost: string`\n  - `recharge_threshold_days: string`\n  - `estimated_next_charge_at?: string`\n  - `runway_months?: string`\n\n### Example\n\n```typescript\nimport NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs();\n\nconst organizationBillingSummary = await client.organizations.billing.topUp('organization_id', { amount: '50.00', 'Idempotency-Key': 'Idempotency-Key' });\n\nconsole.log(organizationBillingSummary);\n```",
    perLanguage: {
      typescript: {
        method: 'client.organizations.billing.topUp',
        example:
          "import NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs({\n  apiKey: process.env['NIRVANA_LABS_API_KEY'], // This is the default and can be omitted\n});\n\nconst organizationBillingSummary = await client.organizations.billing.topUp('organization_id', {\n  amount: '50.00',\n  'Idempotency-Key': 'Idempotency-Key',\n});\n\nconsole.log(organizationBillingSummary.daily_cost);",
      },
      http: {
        example:
  ...
  {
    name: 'recharge',
    endpoint: '/v1/organizations/{organization_id}/billing/recharge',
    httpMethod: 'post',
    ...
    stainlessPath: '(resource) organizations.billing > (method) recharge',
    qualified: 'client.organizations.billing.recharge',
    params: ['organization_id: string;', 'Idempotency-Key: string;'],
    response:
      '{ daily_cost: string; effective_balance: string; monthly_cost: string; recharge_threshold_days: string; estimated_next_charge_at?: string; runway_months?: string; }',
    markdown:
      "## recharge\n\n`client.organizations.billing.recharge(organization_id: string, Idempotency-Key: string): { daily_cost: string; effective_balance: string; monthly_cost: string; recharge_threshold_days: string; estimated_next_charge_at?: string; runway_months?: string; }`\n\n**post** `/v1/organizations/{organization_id}/billing/recharge`\n\nCharge the card on file up to the recharge target now instead of waiting for the scheduled retry. Automatic-policy prepaid organizations only. Idempotency-Key header required.\n\n### Parameters\n\n- `organization_id: string`\n\n- `Idempotency-Key: string`\n\n### Returns\n\n- `{ daily_cost: string; effective_balance: string; monthly_cost: string; recharge_threshold_days: string; estimated_next_charge_at?: string; runway_months?: string; }`\n  Forward-looking billing summary for an organization. All costs are run-rate projections from the organization's current active usage (\"≈ $X/mo at current usage\").\n\n  - `daily_cost: string`\n  - `effective_balance: string`\n  - `monthly_cost: string`\n  - `recharge_threshold_days: string`\n  - `estimated_next_charge_at?: string`\n  - `runway_months?: string`\n\n### Example\n\n```typescript\nimport NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs();\n\nconst organizationBillingSummary = await client.organizations.billing.recharge('organization_id', { 'Idempotency-Key': 'Idempotency-Key' });\n\nconsole.log(organizationBillingSummary);\n```",
    perLanguage: {
      typescript: {
        method: 'client.organizations.billing.recharge',
        example:
          "import NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs({\n  apiKey: process.env['NIRVANA_LABS_API_KEY'], // This is the default and can be omitted\n});\n\nconst organizationBillingSummary = await client.organizations.billing.recharge('organization_id', {\n  'Idempotency-Key': 'Idempotency-Key',\n});\n\nconsole.log(organizationBillingSummary.daily_cost);",
      },
      http: {
        example:
  ...
  {
    name: 'statements',
    endpoint: '/v1/organizations/{organization_id}/billing/statements',
    httpMethod: 'get',
    ...
    stainlessPath: '(resource) organizations.billing > (method) statements',
    qualified: 'client.organizations.billing.statements',
    params: ['organization_id: string;', 'month?: string;'],
    response:
      '{ currency: string; month: string; projects: { project_id: string; project_name: string; resource_types: statement_resource_type[]; subtotal: string; }[]; total: string; }',
    markdown:
      "## statements\n\n`client.organizations.billing.statements(organization_id: string, month?: string): { currency: string; month: string; projects: statement_project[]; total: string; }`\n\n**get** `/v1/organizations/{organization_id}/billing/statements`\n\nGet the itemized monthly usage statement: consumption grouped by project, resource type, and dimension, priced from recorded usage. Defaults to the current month.\n\n### Parameters\n\n- `organization_id: string`\n\n- `month?: string`\n  Billing month, YYYY-MM (UTC). Defaults to the current month.\n\n### Returns\n\n- `{ currency: string; month: string; projects: { project_id: string; project_name: string; resource_types: statement_resource_type[]; subtotal: string; }[]; total: string; }`\n  Itemized usage statement for a billing month: consumption grouped by project, resource type, and dimension. Costs are recorded at consumption time, not re-priced.\n\n  - `currency: string`\n  - `month: string`\n  - `projects: { project_id: string; project_name: string; resource_types: { items: statement_line_item[]; resource_type: string; subtotal: string; }[]; subtotal: string; }[]`\n  - `total: string`\n\n### Example\n\n```typescript\nimport NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs();\n\nconst organizationUsageStatement = await client.organizations.billing.statements('organization_id');\n\nconsole.log(organizationUsageStatement);\n```",
    perLanguage: {
      typescript: {
        method: 'client.organizations.billing.statements',
        example:
          "import NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs({\n  apiKey: process.env['NIRVANA_LABS_API_KEY'], // This is the default and can be omitted\n});\n\nconst organizationUsageStatement = await client.organizations.billing.statements('organization_id');\n\nconsole.log(organizationUsageStatement.currency);",
      },
      http: {
        example:
  ...
  {
    name: 'get',
    endpoint: '/v1/organizations/{organization_id}/billing/recharge_policy',
    httpMethod: 'get',
    ...
    stainlessPath: '(resource) organizations.billing.recharge_policy > (method) get',
    qualified: 'client.organizations.billing.rechargePolicy.get',
    params: ['organization_id: string;'],
    response:
      "{ policy: 'manual' | 'automatic'; policy_args: { fixed: string; runway_days: string; monthly_cap?: string; }; policy_since: string; }",
    markdown:
      "## get\n\n`client.organizations.billing.rechargePolicy.get(organization_id: string): { policy: recharge_policy_mode; policy_args: automatic_policy_args; policy_since: string; }`\n\n**get** `/v1/organizations/{organization_id}/billing/recharge_policy`\n\nGet the organization's recharge configuration: the top-up mode, the fixed and proportional threshold components, and when the current mode took effect.\n\n### Parameters\n\n- `organization_id: string`\n\n### Returns\n\n- `{ policy: 'manual' | 'automatic'; policy_args: { fixed: string; runway_days: string; monthly_cap?: string; }; policy_since: string; }`\n  An organization's current recharge policy. policy_args is null for a manual policy.\n\n  - `policy: 'manual' | 'automatic'`\n  - `policy_args: { fixed: string; runway_days: string; monthly_cap?: string; }`\n  - `policy_since: string`\n\n### Example\n\n```typescript\nimport NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs();\n\nconst organizationRechargePolicy = await client.organizations.billing.rechargePolicy.get('organization_id');\n\nconsole.log(organizationRechargePolicy);\n```",
    perLanguage: {
      typescript: {
        method: 'client.organizations.billing.rechargePolicy.get',
        example:
          "import NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs({\n  apiKey: process.env['NIRVANA_LABS_API_KEY'], // This is the default and can be omitted\n});\n\nconst organizationRechargePolicy = await client.organizations.billing.rechargePolicy.get(\n  'organization_id',\n);\n\nconsole.log(organizationRechargePolicy.policy);",
      },
      http: {
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) organizations.billing.recharge_policy > (method) update',
    qualified: 'client.organizations.billing.rechargePolicy.update',
    params: [
      'organization_id: string;',
      "policy: 'manual' | 'automatic';",
      'policy_args?: { fixed: string; runway_days: string; monthly_cap?: string; };',
    ...
    response:
      "{ policy: 'manual' | 'automatic'; policy_args: { fixed: string; runway_days: string; monthly_cap?: string; }; policy_since: string; }",
    markdown:
      "## update\n\n`client.organizations.billing.rechargePolicy.update(organization_id: string, policy: 'manual' | 'automatic', policy_args?: { fixed: string; runway_days: string; monthly_cap?: string; }): { policy: recharge_policy_mode; policy_args: automatic_policy_args; policy_since: string; }`\n\n**patch** `/v1/organizations/{organization_id}/billing/recharge_policy`\n\nUpdate the organization's recharge mode: manual for self-serve top-ups, or automatic to charge the card on file at the recharge threshold (fixed and proportional required).\n\n### Parameters\n\n- `organization_id: string`\n\n- `policy: 'manual' | 'automatic'`\n  Policy is the top-up mode.\n\n- `policy_args?: { fixed: string; runway_days: string; monthly_cap?: string; }`\n  PolicyArgs carries the threshold parameters. Required when policy is\n\"automatic\"; must be omitted when policy is \"manual\".\n  - `fixed: string`\n    Arbitrary-precision decimal serialized as a string (e.g. \"58.40\").\n  - `runway_days: string`\n    Arbitrary-precision decimal serialized as a string (e.g. \"58.40\").\n  - `monthly_cap?: string`\n    Arbitrary-precision decimal serialized as a string (e.g. \"58.40\").\n\n### Returns\n\n- `{ policy: 'manual' | 'automatic'; policy_args: { fixed: string; runway_days: string; monthly_cap?: string; }; policy_since: string; }`\n  An organization's current recharge policy. policy_args is null for a manual policy.\n\n  - `policy: 'manual' | 'automatic'`\n  - `policy_args: { fixed: string; runway_days: string; monthly_cap?: string; }`\n  - `policy_since: string`\n\n### Example\n\n```typescript\nimport NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs();\n\nconst organizationRechargePolicy = await client.organizations.billing.rechargePolicy.update('organization_id', { policy: 'automatic' });\n\nconsole.log(organizationRechargePolicy);\n```",
    perLanguage: {
      typescript: {
        method: 'client.organizations.billing.rechargePolicy.update',
        example:
          "import NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs({\n  apiKey: process.env['NIRVANA_LABS_API_KEY'], // This is the default and can be omitted\n});\n\nconst organizationRechargePolicy = await client.organizations.billing.rechargePolicy.update(\n  'organization_id',\n  { policy: 'automatic' },\n);\n\nconsole.log(organizationRechargePolicy.policy);",
      },
      http: {
        example:
          'curl https://api.nirvanalabs.io/v1/organizations/$ORGANIZATION_ID/billing/recharge_policy \\\n    -X PATCH \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $NIRVANA_LABS_API_KEY" \\\n    -d \'{\n          "policy": "automatic"\n        }\'',
  ...
  },
  {
    ...
    response:
      "{ dimensions: { id: string; dimension: string; ended_at: string; quantity: number; started_at: string; children?: usage_dimension_leaf[]; }[]; ended_at: string; project_id: string; region: 'us-sva-2'; resource_id: string; resource_type: 'vm' | 'volume' | 'vpc' | 'nks_cluster' | 'nks_node_pool' | 'nks_load_balancer'; started_at: string; }",
    markdown:
  ...
  },
  {
    ...
    params: ["region: 'us-sva-2';", 'name: string;'],
    response:
  ...
  },
  {
    ...
    response:
      "{ id: string; boot_volume_id: string; cpu_config: { vcpu: number; }; created_at: string; data_volume_ids: string[]; memory_config: { size: number; }; name: string; private_ip: string; project_id: string; public_ip: string; public_ip_enabled: boolean; region: 'us-sva-2'; status: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'deleted' | 'error'; subnet_id: string; tags: string[]; updated_at: string; vpc_id: string; vpc_name: string; instance_type?: string; }",
    markdown:
      "## list\n\n`client.compute.vms.list(project_id: string, cursor?: string, limit?: number, name?: string, public_ip_enabled?: boolean, region?: string, sort?: string, status?: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'error', subnet_id?: string, tags?: string[], vpc_id?: string): { id: string; boot_volume_id: string; cpu_config: cpu_config; created_at: string; data_volume_ids: string[]; memory_config: memory_config; name: string; private_ip: string; project_id: string; public_ip: string; public_ip_enabled: boolean; region: region_name; status: resource_status; subnet_id: string; tags: string[]; updated_at: string; vpc_id: string; vpc_name: string; instance_type?: string; }`\n\n**get** `/v1/compute/vms`\n\nList all VMs\n\n### Parameters\n\n- `project_id: string`\n  Project ID of resources to request\n\n- `cursor?: string`\n  Pagination cursor returned by a previous request. Only valid for the same filters and sort order.\n\n- `limit?: number`\n  Maximum number of items to return\n\n- `name?: string`\n  Filter by a case-insensitive substring of the VM name\n\n- `public_ip_enabled?: boolean`\n  Filter by whether a public IP is enabled\n\n- `region?: string`\n  Filter by region\n\n- `sort?: string`\n  Comma-separated sort terms in precedence order, each field:asc or field:desc. Fields: created_at, updated_at, name, status, vcpu, memory\n\n- `status?: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'error'`\n  Filter by VM status\n\n- `subnet_id?: string`\n  Filter by the subnet the VM is attached to\n\n- `tags?: string[]`\n  Filter by tags. Repeat the parameter to require several tags; a VM must carry all of them.\n\n- `vpc_id?: string`\n  Filter by the VPC the VM is attached to\n\n### Returns\n\n- `{ id: string; boot_volume_id: string; cpu_config: { vcpu: number; }; created_at: string; data_volume_ids: string[]; memory_config: { size: number; }; name: string; private_ip: string; project_id: string; public_ip: string; public_ip_enabled: boolean; region: 'us-sva-2'; status: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'deleted' | 'error'; subnet_id: string; tags: string[]; updated_at: string; vpc_id: string; vpc_name: string; instance_type?: string; }`\n  VM details.\n\n  - `id: string`\n  - `boot_volume_id: string`\n  - `cpu_config: { vcpu: number; }`\n  - `created_at: string`\n  - `data_volume_ids: string[]`\n  - `memory_config: { size: number; }`\n  - `name: string`\n  - `private_ip: string`\n  - `project_id: string`\n  - `public_ip: string`\n  - `public_ip_enabled: boolean`\n  - `region: 'us-sva-2'`\n  - `status: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'deleted' | 'error'`\n  - `subnet_id: string`\n  - `tags: string[]`\n  - `updated_at: string`\n  - `vpc_id: string`\n  - `vpc_name: string`\n  - `instance_type?: string`\n\n### Example\n\n```typescript\nimport NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs();\n\n// Automatically fetches more pages as needed.\nfor await (const vm of client.compute.vms.list({ project_id: 'project_id' })) {\n  console.log(vm);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ after: { monthly_total: string; usage_dimensions: { dimension: string; dimension_display_name: string; monthly_amount: string; quantity: number; unit_price: string; }[]; }; before: { monthly_total: string; usage_dimensions: { dimension: string; dimension_display_name: string; monthly_amount: string; quantity: number; unit_price: string; }[]; }; currency: string; diff: { monthly_total_delta: string; usage_dimensions: { after: object; before: object; dimension: string; dimension_display_name: string; monthly_amount_delta: string; }[]; }; priced_at: string; current_summary?: { daily_cost: string; effective_balance: string; monthly_cost: string; recharge_threshold_days: string; estimated_next_charge_at?: string; runway_months?: string; }; updated_summary?: { daily_cost: string; effective_balance: string; monthly_cost: string; recharge_threshold_days: string; estimated_next_charge_at?: string; runway_months?: string; }; }',
    markdown:
  ...
  },
  {
    ...
    markdown:
      "## list\n\n`client.compute.vms.volumes.list(vm_id: string, cursor?: string, kind?: 'boot' | 'data', limit?: number, name?: string, sort?: string, status?: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'error', tags?: string[], type?: 'nvme' | 'abs'): { id: string; created_at: string; kind: volume_kind; name: string; project_id: string; region: region_name; size: number; status: resource_status; tags: string[]; type: volume_type; updated_at: string; vm_id: string; vm_name: string; }`\n\n**get** `/v1/compute/vms/{vm_id}/volumes`\n\nList VM's Volumes\n\n### Parameters\n\n- `vm_id: string`\n\n- `cursor?: string`\n  Pagination cursor returned by a previous request. Only valid for the same VM, filters and sort order.\n\n- `kind?: 'boot' | 'data'`\n  Filter by Volume kind\n\n- `limit?: number`\n  Maximum number of items to return\n\n- `name?: string`\n  Filter by a case-insensitive substring of the Volume name\n\n- `sort?: string`\n  Comma-separated sort terms in precedence order, each field:asc or field:desc. Fields: created_at, updated_at, name, status, size\n\n- `status?: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'error'`\n  Filter by Volume status\n\n- `tags?: string[]`\n  Filter by tags. Repeat the parameter to require several tags; a Volume must carry all of them.\n\n- `type?: 'nvme' | 'abs'`\n  Filter by storage type\n\n### Returns\n\n- `{ id: string; created_at: string; kind: 'boot' | 'data'; name: string; project_id: string; region: 'us-sva-2'; size: number; status: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'deleted' | 'error'; tags: string[]; type: 'nvme' | 'abs'; updated_at: string; vm_id: string; vm_name: string; }`\n  Volume details.\n\n  - `id: string`\n  - `created_at: string`\n  - `kind: 'boot' | 'data'`\n  - `name: string`\n  - `project_id: string`\n  - `region: 'us-sva-2'`\n  - `size: number`\n  - `status: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'deleted' | 'error'`\n  - `tags: string[]`\n  - `type: 'nvme' | 'abs'`\n  - `updated_at: string`\n  - `vm_id: string`\n  - `vm_name: string`\n\n### Example\n\n```typescript\nimport NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs();\n\n// Automatically fetches more pages as needed.\nfor await (const volume of client.compute.vms.volumes.list('vm_id')) {\n  console.log(volume);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    markdown:
      "## list\n\n`client.compute.vms.osImages.list(cursor?: string, display_name?: string, limit?: number, name?: string, sort?: string): { created_at: string; display_name: string; name: string; }`\n\n**get** `/v1/compute/vms/os_images`\n\nList all OS Images\n\n### Parameters\n\n- `cursor?: string`\n  Pagination cursor returned by a previous request. Only valid for the same filters and sort order.\n\n- `display_name?: string`\n  Filter by a case-insensitive substring of the OS Image display name\n\n- `limit?: number`\n  Maximum number of items to return\n\n- `name?: string`\n  Filter by a case-insensitive substring of the OS Image name\n\n- `sort?: string`\n  Comma-separated sort terms in precedence order, each field:asc or field:desc. Fields: created_at, name, display_name, position. An image name embeds its version, so name:asc is lexicographic rather than newest-first; position is the catalog's intended display order.\n\n### Returns\n\n- `{ created_at: string; display_name: string; name: string; }`\n  OS Image details.\n\n  - `created_at: string`\n  - `display_name: string`\n  - `name: string`\n\n### Example\n\n```typescript\nimport NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs();\n\n// Automatically fetches more pages as needed.\nfor await (const osImage of client.compute.vms.osImages.list()) {\n  console.log(osImage);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  {
    name: 'list',
    endpoint: '/v1/compute/vms/{vm_id}/metrics',
    httpMethod: 'get',
    ...
    stainlessPath: '(resource) compute.vms.metrics > (method) list',
    qualified: 'client.compute.vms.metrics.list',
    params: [
      'vm_id: string;',
  ...
  {
    name: 'list',
    endpoint: '/v1/compute/metric_descriptors',
    httpMethod: 'get',
    ...
    perLanguage: {
      typescript: {
        ...
        example:
          "import NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs({\n  apiKey: process.env['NIRVANA_LABS_API_KEY'], // This is the default and can be omitted\n});\n\nconst vmMetricDescriptorList = await client.compute.vms.metricDescriptors.list();\n\nconsole.log(vmMetricDescriptorList.items);",
      },
      http: {
        example:
  ...
  },
  {
    ...
    response:
      "{ id: string; created_at: string; kind: 'boot' | 'data'; name: string; project_id: string; region: 'us-sva-2'; size: number; status: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'deleted' | 'error'; tags: string[]; type: 'nvme' | 'abs'; updated_at: string; vm_id: string; vm_name: string; }",
    markdown:
      "## list\n\n`client.compute.volumes.list(project_id: string, attached?: boolean, cursor?: string, kind?: 'boot' | 'data', limit?: number, name?: string, region?: string, sort?: string, status?: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'error', tags?: string[], type?: 'nvme' | 'abs', vm_id?: string): { id: string; created_at: string; kind: volume_kind; name: string; project_id: string; region: region_name; size: number; status: resource_status; tags: string[]; type: volume_type; updated_at: string; vm_id: string; vm_name: string; }`\n\n**get** `/v1/compute/volumes`\n\nList all volumes\n\n### Parameters\n\n- `project_id: string`\n  Project ID of resources to request\n\n- `attached?: boolean`\n  Filter by whether the Volume is attached to a VM. Combine with vm_id and both must hold.\n\n- `cursor?: string`\n  Pagination cursor returned by a previous request. Only valid for the same filters and sort order.\n\n- `kind?: 'boot' | 'data'`\n  Filter by Volume kind\n\n- `limit?: number`\n  Maximum number of items to return\n\n- `name?: string`\n  Filter by a case-insensitive substring of the Volume name\n\n- `region?: string`\n  Filter by region\n\n- `sort?: string`\n  Comma-separated sort terms in precedence order, each field:asc or field:desc. Fields: created_at, updated_at, name, status, size\n\n- `status?: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'error'`\n  Filter by Volume status\n\n- `tags?: string[]`\n  Filter by tags. Repeat the parameter to require several tags; a Volume must carry all of them.\n\n- `type?: 'nvme' | 'abs'`\n  Filter by storage type\n\n- `vm_id?: string`\n  Filter by the VM the Volume is attached to\n\n### Returns\n\n- `{ id: string; created_at: string; kind: 'boot' | 'data'; name: string; project_id: string; region: 'us-sva-2'; size: number; status: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'deleted' | 'error'; tags: string[]; type: 'nvme' | 'abs'; updated_at: string; vm_id: string; vm_name: string; }`\n  Volume details.\n\n  - `id: string`\n  - `created_at: string`\n  - `kind: 'boot' | 'data'`\n  - `name: string`\n  - `project_id: string`\n  - `region: 'us-sva-2'`\n  - `size: number`\n  - `status: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'deleted' | 'error'`\n  - `tags: string[]`\n  - `type: 'nvme' | 'abs'`\n  - `updated_at: string`\n  - `vm_id: string`\n  - `vm_name: string`\n\n### Example\n\n```typescript\nimport NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs();\n\n// Automatically fetches more pages as needed.\nfor await (const volume of client.compute.volumes.list({ project_id: 'project_id' })) {\n  console.log(volume);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; created_at: string; destination_address: string; destination_ports: string[]; name: string; protocol: 'tcp' | 'udp'; source_address: string; status: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'deleted' | 'error'; tags: string[]; updated_at: string; vpc_id: string; }",
    markdown:
      "## list\n\n`client.networking.firewallRules.list(vpc_id: string, cursor?: string, limit?: number, name?: string, protocol?: 'tcp' | 'udp', sort?: string, status?: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'error', tags?: string[]): { id: string; created_at: string; destination_address: string; destination_ports: string[]; name: string; protocol: 'tcp' | 'udp'; source_address: string; status: resource_status; tags: string[]; updated_at: string; vpc_id: string; }`\n\n**get** `/v1/networking/vpcs/{vpc_id}/firewall_rules`\n\nList all firewall rules\n\n### Parameters\n\n- `vpc_id: string`\n\n- `cursor?: string`\n  Pagination cursor returned by a previous request. Only valid for the same VPC, filters and sort order.\n\n- `limit?: number`\n  Maximum number of items to return\n\n- `name?: string`\n  Filter by a case-insensitive substring of the Firewall Rule name\n\n- `protocol?: 'tcp' | 'udp'`\n  Filter by protocol\n\n- `sort?: string`\n  Comma-separated sort terms in precedence order, each field:asc or field:desc. Fields: created_at, updated_at, name, status, protocol\n\n- `status?: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'error'`\n  Filter by Firewall Rule status\n\n- `tags?: string[]`\n  Filter by tags. Repeat the parameter to require several tags; a Firewall Rule must carry all of them.\n\n### Returns\n\n- `{ id: string; created_at: string; destination_address: string; destination_ports: string[]; name: string; protocol: 'tcp' | 'udp'; source_address: string; status: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'deleted' | 'error'; tags: string[]; updated_at: string; vpc_id: string; }`\n  Firewall rule details.\n\n  - `id: string`\n  - `created_at: string`\n  - `destination_address: string`\n  - `destination_ports: string[]`\n  - `name: string`\n  - `protocol: 'tcp' | 'udp'`\n  - `source_address: string`\n  - `status: 'pending' | 'creating' | 'updating' | 'ready' | 'deleting' | 'deleted' | 'error'`\n  - `tags: string[]`\n  - `updated_at: string`\n  - `vpc_id: string`\n\n### Example\n\n```typescript\nimport NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs();\n\n// Automatically fetches more pages as needed.\nfor await (const firewallRule of client.networking.firewallRules.list('vpc_id')) {\n  console.log(firewallRule);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ id: string; blockchain: string; created_at: string; endpoint: string; name: string; network: string; project_id: string; tags: string[]; updated_at: string; }',
    markdown:
      "## list\n\n`client.rpcNodes.dedicated.list(project_id: string, blockchain?: string, cursor?: string, limit?: number, name?: string, network?: string, sort?: string, tags?: string[]): { id: string; blockchain: string; created_at: string; endpoint: string; name: string; network: string; project_id: string; tags: string[]; updated_at: string; }`\n\n**get** `/v1/rpc_nodes/dedicated`\n\nList all RPC Node Dedicated you created\n\n### Parameters\n\n- `project_id: string`\n  Project ID of resources to request\n\n- `blockchain?: string`\n  Filter by blockchain\n\n- `cursor?: string`\n  Pagination cursor returned by a previous request. Only valid for the same filters and sort order.\n\n- `limit?: number`\n  Maximum number of items to return\n\n- `name?: string`\n  Filter by a case-insensitive substring of the RPC Node Dedicated name\n\n- `network?: string`\n  Filter by network\n\n- `sort?: string`\n  Comma-separated sort terms in precedence order, each field:asc or field:desc. Fields: created_at, name, blockchain, network\n\n- `tags?: string[]`\n  Filter by tags. Repeat the parameter to require several tags; an RPC Node Dedicated must carry all of them.\n\n### Returns\n\n- `{ id: string; blockchain: string; created_at: string; endpoint: string; name: string; network: string; project_id: string; tags: string[]; updated_at: string; }`\n  RPC Node Dedicated details.\n\n  - `id: string`\n  - `blockchain: string`\n  - `created_at: string`\n  - `endpoint: string`\n  - `name: string`\n  - `network: string`\n  - `project_id: string`\n  - `tags: string[]`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs();\n\n// Automatically fetches more pages as needed.\nfor await (const dedicated of client.rpcNodes.dedicated.list({ project_id: 'project_id' })) {\n  console.log(dedicated);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    stainlessPath: '(resource) nks.clusters.load_balancers > (method) update',
    qualified: 'client.nks.clusters.loadBalancers.update',
    params: ['cluster_id: string;', 'load_balancer_id: string;', 'public_ip_enabled: boolean;'],
    response:
      "{ id: string; created_at: string; details: { changes: operation_changes; }; kind: 'vm' | 'volume' | 'vpc' | 'firewall_rule' | 'nks_cluster' | 'nks_node_pool'; project_id: string; resource_id: string; status: 'pending' | 'running' | 'done' | 'failed' | 'unknown'; type: 'create' | 'update' | 'delete' | 'restart'; updated_at: string; }",
    markdown:
  ...
  },
  {
    ...
    response:
      "{ id: string; created_at: string; details: { changes: operation_changes; }; kind: 'vm' | 'volume' | 'vpc' | 'firewall_rule' | 'nks_cluster' | 'nks_node_pool'; project_id: string; resource_id: string; status: 'pending' | 'running' | 'done' | 'failed' | 'unknown'; type: 'create' | 'update' | 'delete' | 'restart'; updated_at: string; }",
    markdown:
      "## update\n\n`client.nks.clusters.pools.update(cluster_id: string, pool_id: string, name?: string, node_count?: number, tags?: string[]): { id: string; created_at: string; details: operation_details; kind: operation_kind; project_id: string; resource_id: string; status: operation_status; type: operation_type; updated_at: string; }`\n\n**patch** `/v1/nks/clusters/{cluster_id}/pools/{pool_id}`\n\nUpdate an NKS node pool\n\n### Parameters\n\n- `cluster_id: string`\n\n- `pool_id: string`\n\n- `name?: string`\n  Name of the node pool.\n\n- `node_count?: number`\n  Number of nodes.\n\n- `tags?: string[]`\n  Tags to attach to the node pool.\n\n### Returns\n\n- `{ id: string; created_at: string; details: { changes: operation_changes; }; kind: 'vm' | 'volume' | 'vpc' | 'firewall_rule' | 'nks_cluster' | 'nks_node_pool'; project_id: string; resource_id: string; status: 'pending' | 'running' | 'done' | 'failed' | 'unknown'; type: 'create' | 'update' | 'delete' | 'restart'; updated_at: string; }`\n  Operation details.\n\n  - `id: string`\n  - `created_at: string`\n  - `details: { changes: object; }`\n  - `kind: 'vm' | 'volume' | 'vpc' | 'firewall_rule' | 'nks_cluster' | 'nks_node_pool'`\n  - `project_id: string`\n  - `resource_id: string`\n  - `status: 'pending' | 'running' | 'done' | 'failed' | 'unknown'`\n  - `type: 'create' | 'update' | 'delete' | 'restart'`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs();\n\nconst operation = await client.nks.clusters.pools.update('pool_id', { cluster_id: 'cluster_id' });\n\nconsole.log(operation);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ after: { monthly_total: string; usage_dimensions: { dimension: string; dimension_display_name: string; monthly_amount: string; quantity: number; unit_price: string; }[]; }; before: { monthly_total: string; usage_dimensions: { dimension: string; dimension_display_name: string; monthly_amount: string; quantity: number; unit_price: string; }[]; }; currency: string; diff: { monthly_total_delta: string; usage_dimensions: { after: object; before: object; dimension: string; dimension_display_name: string; monthly_amount_delta: string; }[]; }; priced_at: string; current_summary?: { daily_cost: string; effective_balance: string; monthly_cost: string; recharge_threshold_days: string; estimated_next_charge_at?: string; runway_months?: string; }; updated_summary?: { daily_cost: string; effective_balance: string; monthly_cost: string; recharge_threshold_days: string; estimated_next_charge_at?: string; runway_months?: string; }; }',
    markdown:
      "## update\n\n`client.nks.clusters.pools.cost.update(cluster_id: string, pool_id: string, name?: string, node_count?: number, tags?: string[]): { after: object; before: object; currency: string; diff: object; priced_at: string; current_summary?: organization_billing_summary; updated_summary?: organization_billing_summary; }`\n\n**patch** `/v1/nks/clusters/{cluster_id}/pools/{pool_id}/cost`\n\nReturn a priced cost quote for the proposed NKS node pool update plus a diff against the current state.\n\n### Parameters\n\n- `cluster_id: string`\n\n- `pool_id: string`\n\n- `name?: string`\n  Name of the node pool.\n\n- `node_count?: number`\n  Number of nodes.\n\n- `tags?: string[]`\n  Tags to attach to the node pool.\n\n### Returns\n\n- `{ after: { monthly_total: string; usage_dimensions: { dimension: string; dimension_display_name: string; monthly_amount: string; quantity: number; unit_price: string; }[]; }; before: { monthly_total: string; usage_dimensions: { dimension: string; dimension_display_name: string; monthly_amount: string; quantity: number; unit_price: string; }[]; }; currency: string; diff: { monthly_total_delta: string; usage_dimensions: { after: object; before: object; dimension: string; dimension_display_name: string; monthly_amount_delta: string; }[]; }; priced_at: string; current_summary?: { daily_cost: string; effective_balance: string; monthly_cost: string; recharge_threshold_days: string; estimated_next_charge_at?: string; runway_months?: string; }; updated_summary?: { daily_cost: string; effective_balance: string; monthly_cost: string; recharge_threshold_days: string; estimated_next_charge_at?: string; runway_months?: string; }; }`\n  Cost quote returned by PATCH /:id/cost: current-state quote, post-update quote, and signed diff. current_summary and updated_summary omitted when the caller cannot view billing.\n\n  - `after: { monthly_total: string; usage_dimensions: { dimension: string; dimension_display_name: string; monthly_amount: string; quantity: number; unit_price: string; }[]; }`\n  - `before: { monthly_total: string; usage_dimensions: { dimension: string; dimension_display_name: string; monthly_amount: string; quantity: number; unit_price: string; }[]; }`\n  - `currency: string`\n  - `diff: { monthly_total_delta: string; usage_dimensions: { after: { monthly_amount: string; quantity: number; unit_price: string; }; before: { monthly_amount: string; quantity: number; unit_price: string; }; dimension: string; dimension_display_name: string; monthly_amount_delta: string; }[]; }`\n  - `priced_at: string`\n  - `current_summary?: { daily_cost: string; effective_balance: string; monthly_cost: string; recharge_threshold_days: string; estimated_next_charge_at?: string; runway_months?: string; }`\n  - `updated_summary?: { daily_cost: string; effective_balance: string; monthly_cost: string; recharge_threshold_days: string; estimated_next_charge_at?: string; runway_months?: string; }`\n\n### Example\n\n```typescript\nimport NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs();\n\nconst costQuoteUpdate = await client.nks.clusters.pools.cost.update('pool_id', { cluster_id: 'cluster_id' });\n\nconsole.log(costQuoteUpdate);\n```",
    perLanguage: {
      typescript: {
  ...
  {
    name: 'list',
    endpoint: '/v1/nks/clusters/{cluster_id}/pools/{pool_id}/volumes',
    httpMethod: 'get',
    ...
    perLanguage: {
      typescript: {
        ...
        example:
          "import NirvanaLabs from '@nirvana-labs/nirvana';\n\nconst client = new NirvanaLabs({\n  apiKey: process.env['NIRVANA_LABS_API_KEY'], // This is the default and can be omitted\n});\n\n// Automatically fetches more pages as needed.\nfor await (const nksNodeVolume of client.nks.clusters.pools.volumes.list('pool_id', {\n  cluster_id: 'cluster_id',\n})) {\n  console.log(nksNodeVolume.id);\n}",
      },
      http: {
        example:
          'curl https://api.nirvanalabs.io/v1/nks/clusters/$CLUSTER_ID/pools/$POOL_ID/volumes \\\n    -H "Authorization: Bearer $NIRVANA_LABS_API_KEY"',
      },
      go: {
        method: 'client.NKS.Clusters.Pools.Volumes.List',
        example:
