...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    description:
      "Charge the organization's card on file and credit its prepaid balance. Send an Idempotency-Key header to make retries safe; responds 402 when the card cannot be charged.",
