...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/vektor/lp/deposit_quote',
  operationId: 'lp_deposit_quote',
};

export const tool: Tool = {
  name: 'create_lp_vektor_deposit_quote',
  description:
    ...
    anyOf: [
      {
        ...
        required: ['amount', 'asset', 'blockchain', 'lp_pool_id'],
      },
      {
        type: 'object',
        properties: {
...
export const handler = async (client: NirvanaLabs, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await client.vektor.lp.depositQuote.create(body));
  } catch (error) {
