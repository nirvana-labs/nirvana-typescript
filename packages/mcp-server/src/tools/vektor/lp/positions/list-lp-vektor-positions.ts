...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/vektor/lp/positions',
  operationId: 'lp_positions',
};

export const tool: Tool = {
  name: 'list_lp_vektor_positions',
  ...
  inputSchema: {
    ...
    anyOf: [
      ...
      },
      {
        ...
        required: ['accounts', 'blockchain', 'lp_pool_ids'],
      },
    ],
    $defs: {
      account: {
...
export const handler = async (client: NirvanaLabs, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await client.vektor.lp.positions.list(body));
  } catch (error) {
