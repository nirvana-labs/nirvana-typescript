...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/vektor/lp/pools',
  operationId: 'lp_pools_list',
};

export const tool: Tool = {
  name: 'list_lp_vektor_pools',
  ...
  inputSchema: {
    ...
    anyOf: [
      ...
      },
      {
        ...
        required: ['blockchain', 'lp_pool_ids'],
      },
    ],
    $defs: {
...
export const handler = async (client: NirvanaLabs, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.vektor.lp.pools.list(body));
};
