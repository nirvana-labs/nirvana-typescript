...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/vektor/lend/withdraw',
  operationId: 'lend_withdraw',
};

export const tool: Tool = {
  name: 'create_lend_vektor_withdraw',
...
export const handler = async (client: NirvanaLabs, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.vektor.lend.withdraw.create(body));
};
