...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/vektor/borrow/positions/historical',
  operationId: 'borrow_positions_historical',
};

export const tool: Tool = {
  name: 'list_historical_borrow_vektor_positions',
...
export const handler = async (client: NirvanaLabs, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await client.vektor.borrow.positions.listHistorical(body));
  } catch (error) {
