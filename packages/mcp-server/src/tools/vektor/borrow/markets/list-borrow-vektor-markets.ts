...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/vektor/borrow/markets',
  operationId: 'borrow_markets',
};

export const tool: Tool = {
  name: 'list_borrow_vektor_markets',
...
export const handler = async (client: NirvanaLabs, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.vektor.borrow.markets.list(body));
};
