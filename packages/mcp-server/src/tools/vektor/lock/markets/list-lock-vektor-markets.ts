...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/vektor/lock/markets',
  operationId: 'lock_markets',
};
...
export const handler = async (client: NirvanaLabs, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await maybeFilter(jq_filter, await client.vektor.lock.markets.list(body)));
  } catch (error) {
