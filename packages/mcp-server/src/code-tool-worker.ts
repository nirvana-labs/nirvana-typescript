...
const fuse = new Fuse(
  [
    ...
    'client.organizations.billing.rechargePolicy.get',
    'client.organizations.billing.rechargePolicy.update',
    'client.quotas.get',
    'client.quotas.list',
    'client.usage.get',
    'client.usage.list',
    ...
    'client.compute.volumes.cost.create',
    'client.compute.volumes.cost.update',
    ...
    'client.networking.vpcs.cost.create',
    'client.networking.vpcs.cost.update',
    ...
    'client.networking.connect.connections.cost.update',
    ...
    'client.nks.clusters.create',
    'client.nks.clusters.delete',
    'client.nks.clusters.get',
    'client.nks.clusters.list',
    'client.nks.clusters.update',
    'client.nks.clusters.availability.create',
    'client.nks.clusters.availability.update',
    'client.nks.clusters.cost.create',
    'client.nks.clusters.cost.update',
    ...
    'client.nks.clusters.pools.cost.create',
