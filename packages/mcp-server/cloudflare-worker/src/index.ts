...
import { McpOptions } from '@nirvana-labs/nirvana-mcp/options';
import { initMcpServer, newMcpServer } from '@nirvana-labs/nirvana-mcp/server';
import { configureLogger } from '@nirvana-labs/nirvana-mcp/logger';
...
function fallbackMcpServer(): McpServer {
  return new McpServer(
    { name: 'nirvana_labs_nirvana_api', version: '1.91.11' },
