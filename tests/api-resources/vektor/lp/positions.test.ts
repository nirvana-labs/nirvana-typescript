...
describe('resource positions', () => {
  ...
  test.skip('list: only required params', async () => {
    const responsePromise = client.vektor.lp.positions.list({
  ...
  test.skip('list: required and optional params', async () => {
    const response = await client.vektor.lp.positions.list({
      accounts: ['0x6b175474e89094c44da98b954eedeac495271d0f'],
      assets: ['asset_01jbz9qc00f8wr64hfe459gb7y'],
      blockchain: 'blockchain_01jbz9nsy8egar70jg79dkwmaf',
      venues: ['venue_01jbz9qc18evw86sg8m0sj9jg5'],
  ...
  test.skip('listHistorical: only required params', async () => {
    const responsePromise = client.vektor.lp.positions.listHistorical({
      accounts: ['0x6b175474e89094c44da98b954eedeac495271d0f'],
      assets: ['asset_01jbz9qc00f8wr64hfe459gb7y'],
      blockchain: 'blockchain_01jbz9nsy8egar70jg79dkwmaf',
  ...
  test.skip('listHistorical: required and optional params', async () => {
    const response = await client.vektor.lp.positions.listHistorical({
      accounts: ['0x6b175474e89094c44da98b954eedeac495271d0f'],
      assets: ['asset_01jbz9qc00f8wr64hfe459gb7y'],
      blockchain: 'blockchain_01jbz9nsy8egar70jg79dkwmaf',
      from: '2021-01-01T12:00:00Z',
