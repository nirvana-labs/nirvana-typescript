...
- <code><a href="./src/resources/nks/kubernetes-versions.ts">KubernetesVersion</a></code>

Methods:

- <code title="get /v1/nks/kubernetes_versions">client.nks.kubernetesVersions.<a href="./src/resources/nks/kubernetes-versions.ts">list</a>({ ...params }) -> KubernetesVersionsCursor</code>
